...
while ($row = mysqli_fetch_array($run)) 
{
    ...
    ?>
            ...
            <div class="col-md-6 mt-4">
              <h6 class="head_tex_p">Passanger</h6>
...
<h2 class="mt-4" style="color: #CDD3DA; font-size: 25px;">Payment Method</h2>

<h6 class="head_tex" style="padding-top: 15px;">Paying With Credit / Debit</h6>
<img src="https://img.icons8.com/color/48/000000/visa.png"/ style="height: 50px;">
<img src="https://img.icons8.com/cotton/64/000000/mastercard.png" / style="height: 50px;">
...
while ($row = mysqli_fetch_array($run)) 
{
    ...
    ?>
             ...
             <div class="row mt-2">
               <div class="col-md-6">
                <h6 class="head_tex" style="padding-top: 15px;">Name</h6>
                 <?php echo $row['f_name']; ?>
               </div>
               <div class="col-md-6" style="text-align: right;">
                 <h6 class="head_tex" style="padding-top: 15px;">Price</h6>
                 <i class="fa fa-inr" aria-hidden="true"></i> <?php echo $row['price_t']; ?>
               </div>
             </div>
...
<?php } ?>
  ...
  <center><a href="payment.php"><button type="button" value="continue" class="btn rounded-pill mt-3" style="width: 13rem; background: #2D84FB; color: #fff;">Continue</button></a></center>
