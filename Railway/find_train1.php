  ...
  <br>
        ...
        <center>
          ...
          <div class="col-md-5 mt-3">
            <center><input type="text" name="t_from" placeholder="From Junction" class="form-control" value="<?php echo $_GET['t_from']; ?>"></center>
          </div>
          
          <div class="col-md-5 mt-3">
            <input type="text" name="t_to" placeholder="From Junction" class="form-control" value="<?php echo $_GET['t_to']; ?>">
          </div>
