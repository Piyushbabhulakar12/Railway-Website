...
?>
                      ...
                      <input type="radio" name="typea" value="SL" required checked> <label>Slepper</label>
                      <input type="hidden" name="train_type" value="SL">
                      	</div>
...
<input type="hidden" name="price_t" value="<?php echo $row['t_rate']; ?>">
