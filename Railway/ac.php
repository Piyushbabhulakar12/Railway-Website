...
?>
                      ...
                      <input type="radio" name="typea" value="AC" required checked> <label>AC</label>
                      <input type="hidden" name="train_type" value="AC">
                      	</div>
...
<input type="hidden" name="price_t" value="<?php echo $row['t_rate']+300;; ?>">
