...
<div class="container mt-4">
       <div class="row">
              ...
              <div class="col-md-3 col-3 text-center">
                     <center>
                            <h5 class="round1" style="background: #2D84FB; color: #fff">3</h5>
                            <p class="text_p">Payment</p>
                     </center>
              </div>
              <div class="col-md-3 col-3 text-center">
                     <center>
                            <h5 class="round1" style="background: #2D84FB; color: #fff">4</h5>
                            <p class="text_p">Done</p>
                     </center>
              </div>
       </div>
</div>
		...
		<div class="col-xl-12 col-12">
			<div style="background: #fff; border-radius: 10px;">
				<div class="container">
                  ...
                  <center><img src="https://img.icons8.com/cotton/100/000000/checked--v1.png"/>

                         <h3>Thanks For Buying!</h3>
                         <h6 style="color: #969494;">Your Booking was Successfully</h6>
                  </center>
         ...
         <div class=" mt-4">
           <div class="row">
             <div class="col-xl-3 col-md-6">
                ...
                <span style="color: #25B865;"><?php echo $uniq_id = $_SESSION['usiw']; ?></span>
             </div>
...
?>
   ...
   <div class="row mt-3">
     ...
     <div class="col-md-6">
       ...
       <?php echo $raaa['train_coach']; ?>/<?php echo $raaa['seat_type']; ?>
     </div>
   </div> 
...
<h2 class="head_tex_p mt-4">Customer Details</h2>
...
?>
  ...
  <div class="row mt-3">
  <div class="col-md-2">
    <h6 class="head_tex" style="padding-top: 10px;">Customer Id.</h6>
    #<?php echo $raaow['id']; ?>
  </div>
  <div class="col-md-3">
    <h6 class="head_tex" style="padding-top: 10px;">Name</h6>
  ...
  <div class="col-md-4">
    ...
    <h6><?php echo $raaow['email']; ?></h6>
  </div>
  <div class="col-md-3">
    <h6 class="head_tex" style="padding-top: 10px;">Contact No.</h6>
...
<br>
<center><input type="button" name="" value="Print" onclick="printDiv('printare')" class="btn rounded-pill" style="width: 12rem; background: #2F3C4E; color: #fff; margin-top: 10px;">&nbsp&nbsp
  <a href="index.php"><input type="button" name="" value="Back To Home" class="btn rounded-pill" style="width: 12rem; background: #2D84FB; color: #fff;  margin-top: 10px;"></a></center>
<br>
</div>
				</div>
			</div>
