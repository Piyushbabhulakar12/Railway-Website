...
<form method="post">
    ...
    <div class="container mt-4">
        ...
        $sql = " select * from book_t where id = '$id' ";
          ...
          <div class="row mt-4">
              <div class="col-md-3">
                  <h6 class="head_tex" style="padding-top: 10px;">Booking Id</h6>
                   <span style="color: #25B865;"><?php echo $row['ticki_id']; ?></span>
              </div>
              <div class="col-md-3">
...
<br>
    ...
    <div class="row">
     ...
     <div class="col-md-3">
       ...
       <?php echo $row['train_type']; ?>-<?php echo $row['id']; ?>/<?php echo $row['train_coach']; ?>/<?php echo $row['seat_type']; ?>
     </div>
     <div class="col-md-3"> 
       ...
       <?php
        ...
        <div class="float-start mt-1">
            <h5>Refand Amount - <span style="color: #F71010;"><?php echo $row['price_t']; ?>/-</span></h5>
        </div>
        <div class="float-end">
             <input type="submit" name="cansel" value="Cancel" class="btn rounded-pill" style="background: #F71010; color: #fff; width: 12rem;">
        </div>
...
<?php
 ...
 $id = $_GET['id'];
        ...
        {
        	$sql = " delete from book_t where id = '$id' ";
        	...
        	if (mysqli_query($conn,$sql)) 
        	{
                ...
                ?>
                   ...
                   <script>
                       ...
                       location.href = "booking_histoy.php";
