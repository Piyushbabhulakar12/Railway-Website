                     ...
                     <div class="col-md-6">
                       ...
                       <input type="text" name="name" placeholder="Enter Full Name">
                         ...
                         <input type="number" name="phone" placeholder="Enter Phone Number">
                          ...
                          <textarea cols="30" rows="5" name="compl" placeholder="Type Description"></textarea><br><br>
...
?>
            ...
            <?php
               ...
               if (isset($_POST['submit'])) 
               {
               	 ...
               	 $sql = " insert into contact (name,phone,email,compl,user_id) values ('$name','$phone','$email','$compl','$id') ";
