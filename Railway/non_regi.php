...
@media only screen and (max-width: 300px)
{
 .top_n
  ...
  <a href="non/find_train.php">Find Train</a>
 <a href="non/book_id.php">Booking Id</a>
 <a href="regi/log.php">Sign Up</a>
 <a href="regi/index.php">Registration</a>
 <a href="non/contact.php">Contact Us</a>
</div>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <li class="nav-item">
    <a class="nav-link nav_link" href="non/find_train.php" style="color: #455A64; border-radius: 50px;">Find Train</a>
  </li>
  <li class="nav-item">
    <a class="nav-link nav_link" href="non/book_id.php" style="color: #455A64; border-radius: 50px;">Booking Id</a>
  </li>
  <li class="nav-item">
...
<div class="bg">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
       <center><h2 style="color: #ffff; margin-top: 190px; font-size: 40px;">Book Your Train ticket at ease. </h2>
       <a href="regi/log.php"><button type="button" value="Sign" class="btn btn-outline-light rounded-pill mt-2" style="width: 10rem;">Sign Up</button></a>&nbsp
       <a href="regi/index.php"><button type="button" value="Sign" class="btn btn-light rounded-pill mt-2" style="width: 10rem;">Registration</button></a>
     </center>
      </div>
    </div>
  </div>
